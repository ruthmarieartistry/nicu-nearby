...
export default function NICUFinder() {
  ...
  return React.createElement('div', { className: 'h-full bg-white overflow-auto' },
      ...
      React.createElement('div', { className: 'grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8' },
        ...
        React.createElement('main', { className: 'md:col-span-9' },
          React.createElement('div', { className: 'mb-4 md:mb-6' },
            React.createElement('img', { src: '/nicunearby-logo.png', alt: 'NICU Nearby', className: 'h-[70px] w-auto mb-3 sm:mb-4' }),
            React.createElement('p', { className: 'text-xs text-gray-500 border-b border-gray-300 pb-3 mb-4 md:hidden' }, 'Made for Alcea Surrogacy, © RME 2025 [v2.0]'),
    ...
    showMethod && React.createElement('div', {
      ...
      React.createElement('div', { className: 'text-right text-sm text-gray-500 mt-4 px-4' },
